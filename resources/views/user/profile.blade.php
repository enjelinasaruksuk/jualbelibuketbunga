...
<body class="bg-[#f9fafb] min-h-screen flex flex-col">
    ...
    <header class="flex items-center justify-between bg-white px-6 py-3 border-b border-gray-200">
        <div class="flex items-center space-x-2">
            <img alt="Bloomify bouquet flowers logo black text" class="w-20 h-30 object-contain" height="80" src="{{ asset('images/logo.png') }}" width="80" />
        </div>
        <div class="flex items-center space-x-4 flex-grow max-w-xl mx-6">
            <div class="relative flex-grow">
                <input class="w-full rounded-full bg-[#f3f4f6] text-sm placeholder-gray-400 py-2 px-4 pl-10 focus:outline-none focus:ring-2 focus:ring-black" placeholder="Search" type="search" />
        ...
        <div class="flex items-center space-x-4 ml-6 text-gray-900 text-lg">
            <button aria-label="Cart" class="hover:text-gray-700">
                <i class="fas fa-shopping-cart">
                </i>
            </button>
            <button aria-label="User" class="hover:text-gray-700">
                <i class="fas fa-user">
                </i>
            </button>
            <button aria-label="Logout" class="hover:text-gray-700">
    ...
    <main class="flex flex-grow bg-white max-w-7xl mx-auto w-full mt-6 rounded-sm shadow-sm">
        ...
        <aside class="flex flex-col items-center bg-[#f3f4f6] w-40 py-8 space-y-6 select-none">
            <img alt="User profile icon gray circle with person silhouette" class="rounded-full" height="80" src="{{ asset('images/logo.png') }}" width="80" />
            ...
            <nav class="flex flex-col space-y-2 w-full px-4">
                ...
                <button class="text-xs rounded-md py-2 w-full text-center font-semibold text-gray-700 hover:bg-[#f9e6d9]" type="button">
                    Riwayat Pesanan
                </button>
            </nav>
        </aside>
        ...
        <section class="flex-grow p-8">
            ...
            <div class="flex items-center space-x-4 mb-6">
                <img alt="User profile icon gray circle with person silhouette" class="rounded-full" height="60" src="{{ asset('images/logo.png') }}" width="60" />
