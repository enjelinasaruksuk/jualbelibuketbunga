...
<body class="bg-[#f9fafb] min-h-screen flex flex-col">
    ...
    <header class="flex items-center justify-between bg-white px-6 py-3 border-b border-gray-200">
        <div class="flex items-center space-x-2">
            <img alt="Logo Bloomify bouquet flowers dengan teks hitam" class="w-20 h-30 object-contain" height="80" src="{{ asset('images/logo.png') }}" width="80" />
        </div>
    ...
    <main class="flex flex-grow bg-white max-w-7xl mx-auto w-full mt-6 rounded-sm shadow-sm">
        ...
        <aside class="flex flex-col items-center bg-[#f3f4f6] w-40 py-8 space-y-6 select-none">
            <img alt="Ikon profil pengguna lingkaran abu-abu dengan siluet orang" class="rounded-full" height="80" src="{{ asset('images/logo.png') }}" width="80" />
        ...
        <section class="flex-grow p-8">
            ...
            <div class="flex items-center space-x-4 mb-6">
                <img alt="Ikon profil pengguna lingkaran abu-abu dengan siluet orang" class="rounded-full" height="60" src="{{ asset('images/logo.png') }}" width="60" />
